...
export function Branding() {
    return (
        <section className="relative w-full overflow-hidden bg-[#0A0C10]">
            ...
            <div className="container mx-auto px-1 md:px-2 relative z-10 py-2 lg:py-4">
                <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
                    ...
                    <div className="flex-1 text-center lg:text-left space-y-1">
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-base md:text-lg max-w-xl mx-auto lg:mx-0 mt-2 leading-relaxed">
                        ...
                        <motion.div 
                            ...
                            className="flex flex-wrap justify-center lg:justify-start gap-6 md:gap-10 pt-1"
                        >
                    ...
                    >
                        ...
                        <div className="relative z-10 w-full max-w-[260px] mx-auto aspect-[10/9] group">
