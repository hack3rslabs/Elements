        ...
        <div className="container">
          <div className="flex items-center justify-center gap-6 md:gap-12 overflow-x-auto whitespace-nowrap text-xs md:text-sm text-muted-foreground">
            {[
              ...
              { icon: Phone, text: "Call: +91 94966 64445", highlight: false },
            ].map(item => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <div className="space-y-3">
                <a href="tel:+919496664445" className="flex items-center gap-3 bg-white/5 rounded-xl p-3 hover:bg-white/10 transition-colors">
                  <div className="h-10 w-10 rounded-full bg-[#1877F2] flex items-center justify-center shrink-0">
                    <Phone className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-sm font-medium">Call Us</p>
                    <p className="text-xs text-gray-400">+919496664445</p>
                  </div>
                </a>
                <a href={`https://wa.me/919496664445?text=${encodeURIComponent("Hi! I need bulk pricing for my project.")}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/5 rounded-xl p-3 hover:bg-white/10 transition-colors">
