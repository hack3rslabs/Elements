...
export default function AdminPage() {
    ...
    const handleToggleSlide = async (id: string) => {
        try {
            ...
            const d: { success: boolean; data: HeroSlide } = await res.json();
